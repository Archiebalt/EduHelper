...
public class AnswerMethodFactory {
	...
	public EditMessageText getEditMessageText(Long chatId, Integer messageId, String text) {
		return EditMessageText.builder()
				.chatId(chatId)
				.messageId(messageId)
				.text(text)
	...
	public EditMessageReplyMarkup getEditMessageReplyMarkup(CallbackQuery callbackQuery, InlineKeyboardMarkup inlineKeyboardMarkup) {
	...
	public SetMyCommands getBotCommandScopeChat(Long chatId, Map<String, String> commands) {
